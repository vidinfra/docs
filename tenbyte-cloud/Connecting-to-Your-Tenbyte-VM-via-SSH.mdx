...
<img
  src="/tenbyte-cloud/SSH-Connection/06.png"
  alt={true}s
  width="100"
/>
...
<img
  src="/tenbyte-cloud/SSH-Connection/07.png"
  alt={true}s
  width="100"
/>
...
7. Configure Your VM for SSH Access
    ...
    - Scroll down to the **Authentication section** and locate the line:
      ...
      ```
<img
  src="/tenbyte-cloud/SSH-Connection/08.png"
  alt={true}
  width="100"
/>
    ...
    - Remove the ```#``` at the beginning and change the value to ```yes```:
      ...
      ```
<img
  src="/tenbyte-cloud/SSH-Connection/09.png"
  alt={true}
  width="100"
/>
...
<img
  src="/tenbyte-cloud/SSH-Connection/010.png"
  alt={true}
  width="100"
/>
...
12. Connect via SSH
    - Enter the following command, replacing ```<vm_ip>``` with your copied **VM IP** and ```root``` with your **username**:
      ...
      ```
<img
  src="/tenbyte-cloud/SSH-Connection/10.png"
  alt={true}
  width="100"
/>
...
<img
  src="/tenbyte-cloud/SSH-Connection/11.png"
  alt={true}
  width="100"
/>
